...
from openerp.addons.payment_authorize_cim.lib.authorize.schemas import CustomerBaseSchema
from openerp.addons.payment_authorize_cim.lib.authorize.schemas import CreateCustomerSchema
