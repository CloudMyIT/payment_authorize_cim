...
from openerp.addons.payment_authorize_cim.lib.authorize.schemas import CreateRecurringSchema
from openerp.addons.payment_authorize_cim.lib.authorize.schemas import UpdateRecurringSchema
